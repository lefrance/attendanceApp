...
public class EmployeeInfo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_naam = new javax.swing.JTextField();
        ...
        txt_voornaam = new javax.swing.JTextField();
        ...
        jLabel4.setText("Leeftijd");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setText("MobielNo.");

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("StudieRichting");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setText("InschrijvingDag");

        txt_studentid.setEditable(false);
        txt_studentid.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_studentid.setToolTipText("");
        txt_studentid.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 204, 204), 1, true));
        ...
        txt_naam.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_naam.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 204, 204), 1, true));
        ...
        jComboBox_qualificaton.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ICT", "WTB", "ET", "HLO", "INFRA", "FT", "IA", "LVD", "APH", "Agro", " " }));
        jComboBox_qualificaton.setSelectedIndex(-1);
        jComboBox_qualificaton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox_qualificatonActionPerformed(evt);
            }
        });
        ...
        txt_voornaam.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_voornaam.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 204, 204), 1, true));
        txt_voornaam.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_voornaamActionPerformed(evt);
            }
        });

        jRadioButton2.setText("r3");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_studentid, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(txt_voornaam, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_naam, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(19, 19, 19)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jRadioButton_Male, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addGap(19, 19, 19))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                        .addComponent(txt_studentid, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)))
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txt_naam, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txt_voornaam, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jLabel3)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(jComboBox_qualificaton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jLabel7))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
       String naam_validate = txt_naam.getText();
       String voornaam_validate =txt_voornaam.getText();
       ...
       String cn_validate =txt_contactno.getText();
         ...
         if(naam_validate.equals("")){
         
             JOptionPane.showMessageDialog(null, "PLEASE TYPE NAME");
             
         }
         else if(voornaam_validate.equals("")){
        ...
        try {
            String sql;
            sql = "INSERT INTO `employeeinfo` ( `Naam`, `Voornaam`, `Geslacht`, `Leeftijd`, `MobielNo`, `StudieRichting`, `InschrijvingDag`, `Adres`, `EmpImage`)values(?,?,?,?,?,?,?,?,?)";
            //sql = "insert into employeeinfo (Naam,Voornaam,Geslacht,Leeftijd,MobielNo,StudieRichting,Adres,EmpImage)values(?,?,?,?,?,?,?,?,?)";
            pst=conn.prepareStatement(sql);
            
            pst.setString(1, txt_naam.getText());
            pst.setString(2, txt_voornaam.getText());
...
String strDateOutput = sdf.format(date);
    ...
    private void Table_dataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table_dataMouseClicked
       ...
       String Table_click=(Table_data.getModel().getValueAt(row, 0).toString());
        ...
        try {
         String sql = "select * from employeeinfo where StudentID='"+Table_click+"'";   
         pst=conn.prepareStatement(sql);
         rs=pst.executeQuery();
         
         if(rs.next()){
         String strempid = rs.getString("StudentID");
         txt_studentid.setText(strempid);
         
         String strname = rs.getString("Naam");
         txt_naam.setText(strname);
         
         String strbg = rs.getString("Voornaam");
         txt_voornaam.setText(strbg);
         
         String strgender = rs.getString("Geslacht");
         if("M".equals(strgender)){
         
         jRadioButton_Male.setSelected(true);
         }
         
         if("V".equals(strgender)){
         jRadioButton_Female.setSelected(true);
         
         }
         
         String strage = rs.getString("Leeftijd");
         txt_age.setText(strage);
         
         
         String strcn = rs.getString("MobielNo");
         txt_contactno.setText(strcn);
         
         
         String strqua =rs.getString("StudieRichting");
         jComboBox_qualificaton.setSelectedItem(strqua);
         
         
String dateval = rs.getString("InschrijvingDag");
java.util.Date date=new SimpleDateFormat("yyyy-MM-dd").parse(dateval);
jDateChooser1.setDate(date);

String straddress = rs.getString("Adres");
...
employeeimage=imagedata;
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        try {
          String sql = "update employeeinfo set Naam=?,Voornaam=?,Geslacht=?,Leeftijd=?,MobielNo=?,StudieRichting=?,InschrijvingDag=?,Adres=?,EmpImage=? where StudentID=?";  
         pst=conn.prepareStatement(sql);
...
String strDateOutput = sdf.format(date);
      ...
      pst.setString(10, txt_studentid.getText());
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        if(p==0){
            ...
            try {
         String sql = "delete from employeeinfo where StudentID=?"; 
         pst=conn.prepareStatement(sql);
    ...
    private void jComboBox_qualificatonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_qualificatonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBox_qualificatonActionPerformed
    ...
    private void txt_voornaamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_voornaamActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_voornaamActionPerformed
    ...
    private javax.swing.JTextField txt_naam;
    private javax.swing.JTextField txt_studentid;
    private javax.swing.JTextField txt_voornaam;
